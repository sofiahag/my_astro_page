...
export declare const createWorker: (ipcPort: number, ipcValidationKey: string, isNodeDebugging: boolean | 'brk' | undefined, type: 'pages' | 'app', nextConfig: NextConfigComplete) => Promise<RenderWorker>;
